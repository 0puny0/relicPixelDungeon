...
public class Dungeon {
	...
	public static void switchLevel( final Level level, int pos ) {
		...
		if (hero.buff(Terraforming.class)!=null){
			Terraforming t=hero.buff(Terraforming.class);
			t.isSneak();
			if (t.doorOpps[depth]>0){
		...
		if(hero.buff( Light.class )!=null||hero.buff(BlessingPower.Blessing.class)!=null){
			hero.viewDistance =Math.max( Light.DISTANCE, hero.viewDistance );
		}
