	...
	public WndHeroInfo( HeroClass cl ){
		...
		switch (cl){
			...
			case HUNTRESS:
				...
				break;
			case ADVENTURER:
				tabIcon= new ItemSprite(ItemSpriteSheet.BLESSED_PEARL, null);
				break;
			case DUELIST:
				tabIcon= new ItemSprite(ItemSpriteSheet.SPARE_SWORD, null);
				break;
		}
			...
			switch (cls){
				case WARRIOR: default:
					icons = new Image[]{ new ItemSprite(ItemSpriteSheet.SEAL),
							Icons.get(Icons.STRENGTH),
							new ItemSprite(ItemSpriteSheet.KNIFE_FORK),
							new ItemSprite(ItemSpriteSheet.SCROLL_ISAZ)};
					break;
				case MAGE:
					icons = new Image[]{ new ItemSprite(ItemSpriteSheet.MAGES_STAFF),
							Icons.get(Icons.MANNABARRIER),
				...
				case ROGUE:
					...
					break;
				case HUNTRESS:
					icons = new Image[]{ new ItemSprite(ItemSpriteSheet.SPIRIT_ARROW),
				...
				case ADVENTURER:
					...
					break;
				case DUELIST:
					icons=new Image[]{ new ItemSprite(ItemSpriteSheet.SPARE_SWORD),
