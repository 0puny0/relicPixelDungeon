...
public class ScrollOfMetamorphosis extends ExoticScroll {
	...
	public static void onMetamorph( Talent oldTalent, Talent newTalent ){
		...
		if(!Dungeon.hero.hasTalent(oldTalent)){
			Talent.onTalentDegrade(Dungeon.hero,oldTalent);
		}
	...
	public static class WndMetamorphReplace extends Window {
		...
		static {
			...
			restrictedTalents.put(Talent.CHARGING_EXPANSION,HeroClass.ROGUE);
			restrictedTalents.put(Talent.CONCENTRATE_SHOOT,HeroClass.HUNTRESS);
			restrictedTalents.put(Talent.UPGRADE_TRANSFER,HeroClass.ADVENTURER);
			restrictedTalents.put(Talent.WEAPON_RECHARGING,HeroClass.DUELIST);
