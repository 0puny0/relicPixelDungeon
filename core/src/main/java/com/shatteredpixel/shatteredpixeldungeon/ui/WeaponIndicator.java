...
public class WeaponIndicator extends Tag{
    Visual primaryVis;
    Visual secondVis;
    ...
    public static void setAction(ActionIndicator.Action action){
        synchronized (ActionIndicator.class) {
    ...
    public static void clearAction(ActionIndicator.Action action){
        synchronized (ActionIndicator.class) {
