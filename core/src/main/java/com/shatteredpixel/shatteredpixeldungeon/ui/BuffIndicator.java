...
public class BuffIndicator extends Component {
	...
	public static final int IMPETUS		=	61;
	public static final int MANABARRIER		=	62;
	public static final int CONFUSION=63;
	public static final int CROWNPOWER=64;
	public static final int STUFFED=65;
	public static final int BATTLE_STANCE=66;
	...
	public static final int ARMOR_BREAK=71;
	public static final int ADVANCE=72;
	public static final int CHALLENGE=73;
	public static final int DODGE=75;
	public static final int SHELTER=76;
